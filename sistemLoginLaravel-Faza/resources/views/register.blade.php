            ...
            <div class="w-full sm:max-w-md mt-6 px-8 py-6 bg-white shadow-md overflow-hidden sm:rounded-lg">
                <form method="POST" action="{{ route('register.submit') }}">
                    ...
                    <div>
                        ...
                        <input class="px-3 py-2 border border-gray-300 focus:border-indigo-500 focus:outline-indigo-500 rounded-md shadow-sm block w-full" id="name" type="text" name="name" required="required" autocomplete="name" />
                    </div>

                    <div class="mt-5">
                        <label class="block font-medium text-sm text-gray-700 mb-1" for="email"> Email </label>
                        <input class="px-3 py-2 border border-gray-300 focus:border-indigo-500 focus:outline-indigo-500 rounded-md shadow-sm block w-full" id="email" type="email" name="email" required="required" autofocus="autofocus" autocomplete="username" />
                    </div>
                    ...
                    <div class="mt-4">
                        <a href="{{ route('login.tampil') }}" class="text-sm font-semibold hover:underline hover:text-indigo-500">Already have account?</a>
                    </div>
