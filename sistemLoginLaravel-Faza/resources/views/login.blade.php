    ...
    <div class="font-sans text-gray-900 antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
            ...
            <div class="w-full sm:max-w-md mt-6 px-8 py-6 bg-white shadow-md overflow-hidden sm:rounded-lg">
                ...
                <div class="mt-4">
                    <a href="{{ route('register.tampil') }}" class="text-sm font-semibold hover:underline hover:text-indigo-500">Not have account yet?</a>
                </div>
